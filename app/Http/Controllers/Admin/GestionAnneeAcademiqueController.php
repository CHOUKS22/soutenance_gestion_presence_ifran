...
class GestionAnneeAcademiqueController extends Controller
{
    ...
    {
        return view('admin.annees-academiques.annee-academique-show', compact('annee_academique'));
    }
    ...
    {
        return view('admin.annees-academiques.annee-academique-edit', compact('annee_academique'));
    }
