...
class GestionMatiereController extends Controller
{
    public function index()
    {
        ...
        return view('coordinateur.matieres.matieres', compact('matieres'));
    }

    public function show(Matiere $matiere)
    {
        return view('coordinateur.matieres.matiere-show', compact('matiere'));
    }

    public function create()
    {
        return view('coordinateur.matieres.matiere-create');
    }
    ...
    {
        return view('coordinateur.matieres.matiere-edit', compact('matiere'));
    }
