...
<div class="min-h-screen bg-gray-50">
    <div class="p-6">
        ...
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="{{ route('gestion-statuts-seances.create') }}"
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            <div class="bg-white rounded-xl shadow-md p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-blue-600">{{ $statutsSeances->count() }}</p>
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-md p-6">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm text-gray-600 font-medium">Séances</p>
                        <p class="text-3xl font-bold text-green-600">
                            {{ $statutsSeances->sum(function($statut) { return $statut->seances ? $statut->seances->count() : 0; }) }}
                        </p>
                    </div>
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-sm font-bold text-purple-600">
                            {{ $statutsSeances->sortByDesc(function($statut) { return $statut->seances ? $statut->seances->count() : 0; })->first()?->libelle ?? 'Aucun' }}
                        </p>
                    </div>
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-sm font-bold text-orange-600">
                            {{ $statutsSeances->sortByDesc('created_at')->first()?->created_at->format('d/m/Y') ?? 'Aucune' }}
                        </p>
                    </div>
