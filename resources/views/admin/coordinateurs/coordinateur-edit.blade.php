...
<div class="min-h-screen bg-gray-50">
    <div class="p-6 max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            <div class="p-6">
                <form method="POST" action="{{ route('gestion-coordinateurs.update', $coordinateur) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text"
                                       id="nom"
                                       name="nom"
                                       value="{{ old('nom', $coordinateur->user->nom) }}"
                            ...
                            <div>
                                ...
                                <input type="text"
                                       id="prenom"
                                       name="prenom"
                                       value="{{ old('prenom', $coordinateur->user->prenom) }}"
                            ...
                            <div>
                                ...
                                <input type="email"
                                       id="email"
                                       name="email"
                                       value="{{ old('email', $coordinateur->user->email) }}"
                            ...
                            <div>
                                <label for="role" class="block text-sm font-medium text-gray-700 mb-2">Type de coordinateur</label>
                                <select id="role"
                                        name="role"
                                    ...
                                    <option value="coordinateur_pedagogique"
                                            {{ old('role', $coordinateur->role) === 'coordinateur_pedagogique' ? 'selected' : '' }}>
                                        Coordinateur Pédagogique
                                    </option>
                                    <option value="coordinateur_filliere"
                                            {{ old('role', $coordinateur->role) === 'coordinateur_filliere' ? 'selected' : '' }}>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="flex items-center space-x-4">
                                    @if($coordinateur->user->photo)
                                        <img src="{{ asset('storage/' . $coordinateur->user->photo) }}"
                                             alt="Photo actuelle"
