...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">Modifier le Semestre</h1>
    ...
    <div class="bg-white rounded-lg shadow-lg p-6">
        <form action="{{ route('gestion-semestres.update', $semestre->id) }}" method="POST" id="semestreForm">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text"
                           name="libelle"
                           id="libelle"
                           value="{{ old('libelle', $semestre->libelle) }}"
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                           required
            ...
            <div class="mt-6 p-4 bg-gray-50 rounded-lg">
                ...
                <div class="text-sm text-gray-600 space-y-1">
                    <p><span class="font-medium">Créé le:</span> {{ $semestre->created_at ? $semestre->created_at->format('d/m/Y à H:i') : 'Non disponible' }}</p>
                    <p><span class="font-medium">Dernière modification:</span> {{ $semestre->updated_at ? $semestre->updated_at->format('d/m/Y à H:i') : 'Non disponible' }}</p>
                </div>
            </div>
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-red-600 text-sm mt-1">
                    La suppression de ce semestre est irréversible. Toutes les données associées seront perdues.
                </p>
            </div>
    ...
    <div class="flex items-center justify-center min-h-screen px-4">
        <div class="bg-white rounded-lg p-6 max-w-md w-full">
            ...
            <p class="text-gray-500 mb-6">
                Êtes-vous sûr de vouloir supprimer ce semestre ? Cette action est irréversible et supprimera toutes les données associées.
            </p>
