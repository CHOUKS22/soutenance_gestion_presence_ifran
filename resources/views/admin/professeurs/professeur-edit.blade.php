...
<div class="min-h-screen bg-gray-50">
    <div class="p-6 max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            <div class="p-6">
                <form method="POST" action="{{ route('gestion-professeurs.update', $professeur) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text"
                                       id="nom"
                                       name="nom"
                                       value="{{ old('nom', $professeur->user->nom) }}"
                            ...
                            <!-- Filière -->
                            <div>
                                <label for="filliere_id" class="block text-sm font-medium text-gray-700 mb-2">Filière</label>
                                <select id="filliere_id"
                                        name="filliere_id"
                                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('filliere_id') border-red-500 @enderror">
                            ...
                            {{-- <div class="md:col-span-2">
                                ...
                                <div class="flex items-center space-x-4">
                                    @if($professeur->user->photo)
                                        <img src="{{ asset('storage/' . $professeur->user->photo) }}"
                                             alt="Photo actuelle"
